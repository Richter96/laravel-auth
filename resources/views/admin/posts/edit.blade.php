...
<div class="container">
    ...
    <form action="{{ route('admin.posts.store') }}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" aria-describedby="helpId" placeholder="Inserisci un titolo" value="{{ old('title', $post->title) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('image') is-invalid @enderror" name="image" id="image" aria-describedby="helpId" placeholder="http://" value="{{ old('image', $post->image) }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('text') is-invalid @enderror" name="text" id="text" rows="5" placeholder="Inserisci qui la descrizione">{{ old('text', $post->text) }}</textarea>
            @error('text')
            <div class="alert alert-danger" role="alert">
